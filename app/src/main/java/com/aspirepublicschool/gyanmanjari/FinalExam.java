 ...
 * Use the {@link FinalExam#newInstance} factory method to
...
public class FinalExam extends Fragment {
     ...
     * @return A new instance of fragment FinalExam.
     */
    // TODO: Rename and change types and number of parameters
    public static FinalExam newInstance(String param1, String param2) {
        FinalExam fragment = new FinalExam();
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                if (resultModel.getTest_type().equals("Final Exam")){
                                   ...
                                   // barEntries.add(new BarEntry(i-1,Integer.parseInt(result.getString("obtain"))));
                                }
                         ...
                         /*   int growth_c=0;
                           ...
                           /* pieEntries.add(new PieEntry(growth_c,resultModelList.get(0).getTest_type()));
                            ...
                            //barEntries.add(new BarEntry(resultList.size(),Integer.parseInt(resultModel.getObtain_marks())));
                          /*  BarDataSet barDataSet = new BarDataSet(barEntries,"Marks Subject Wise");
                            ...
                            barChart.invalidate();*/
                          /*  String[] name = new String[]{resultModel.getSubject()};
                            XAxis xAxis = barChart.getXAxis();
