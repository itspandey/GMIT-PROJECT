 ...
 * {@link HalfYearlyTimeTableFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link HalfYearlyTimeTableFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class HalfYearlyTimeTableFragment extends Fragment {
    ...
    public HalfYearlyTimeTableFragment() {
     ...
     * @return A new instance of fragment HalfYearlyTimeTableFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static HalfYearlyTimeTableFragment newInstance(String param1, String param2) {
        HalfYearlyTimeTableFragment fragment = new HalfYearlyTimeTableFragment();
                ...
                try {
                    ...
                    for (int i=0; i<array.length(); i++){
                       ...
                       /* testTimeTableModelList.add(new TestTimeTableModel(
                        ...
                        if (testTimeTableModel.getTest_type().equals("Half Term Exam")){
