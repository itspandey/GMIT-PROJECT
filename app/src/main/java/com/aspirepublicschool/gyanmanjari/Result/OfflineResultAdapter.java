...
public class OfflineResultAdapter extends RecyclerView.Adapter {
    Context ctx;
    ...
    public OfflineResultAdapter(Context ctx, ArrayList<Result> resultArrayList) {
        this.ctx = ctx;
    ...
    {
        View MyView = LayoutInflater.from(ctx).inflate(R.layout.result_new_list, null);
