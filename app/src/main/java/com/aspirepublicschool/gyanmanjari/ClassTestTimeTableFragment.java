 ...
 * Use the {@link ClassTestTimeTableFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ClassTestTimeTableFragment extends Fragment {
    ...
    public ClassTestTimeTableFragment() {
     ...
     * @return A new instance of fragment ClassTestTimeTableFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ClassTestTimeTableFragment newInstance(String param1, String param2) {
        ClassTestTimeTableFragment fragment = new ClassTestTimeTableFragment();
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                       ...
                       /* testTimeTableModelList.add(new TestTimeTableModel(
                        ...
                        if (testTimeTableModel.getTest_type().equals("Class Test")) {
