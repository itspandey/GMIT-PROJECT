...
public class ShopList extends AppCompatActivity {
    ...
    public static String s_id,ss_name,s_img,s_cont;
    int total;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager horizontalLayoutManagaer1
                = new LinearLayoutManager(ShopList.this, LinearLayoutManager.HORIZONTAL, false);
        ...
        SubcategoriesAdapter adapter = new SubcategoriesAdapter(ShopList.this, subcategoriesList);
    ...
    private void loadShop() {
        String SHOP_URL = Common.GetWebServiceURL()+"displayallShop.php";
        SharedPreferences mPrefs = PreferenceManager.getDefaultSharedPreferences(ShopList.this);
    ...
    private void loadStudentData() {
        Common.progressDialogShow(ShopList.this);
        SharedPreferences mPrefs = PreferenceManager.getDefaultSharedPreferences(ShopList.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, STUDENT_PROFILE_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    Common.progressDialogDismiss(ShopList.this);
                    JSONArray array = new JSONArray(response);
                    for (int i = 0; i < array.length(); i++) {
                       ...
                       // Glide.with(ShopList.this).load(DP_URL).into(profile_image);
                        ...
                        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(ShopList.this);
       ...
       // badge=(NotificationBadge)view.findViewById(R.id.badge);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ShopList.this, Cart.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_order:
                intent = new Intent(ShopList.this, MyOrder.class);
                startActivity(intent);
                // do something
                return true;
            case R.id.action_cart:
                intent = new Intent(ShopList.this, Cart.class);
                startActivity(intent);
                // do something
                return true;
            default:
      ...
      /*  if(badge==null) return;
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Volley.newRequestQueue(ShopList.this).add(request);
