...
public class Common {
  // public final static String IP = "http://www.zocarro.net/school_mobile";
    public final static String MAIN_URL = "https://www.aspirepublicschool.net/zocarro_mobile";
   //public final static String  IP = "http://192.168.43.28";
    ...
    public static String GetBaseURL(){
        return MAIN_URL+ "/school/";
    }
    public static String GetWebServiceURL(){
        return GetBaseURL() + "ws/uniform/";
    }
  ...
  /*  public static String GetBaseImageURL()
   ...
   public static String GetBaseImageURL()
   {
       return "https://www.aspirepublicschool.net/zocarro/image/clothing";
   }
