...
public class AllShopDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_shop_details);
        ...
        Glide.with(AllShopDetails.this).load(ImageUrl).into(imgshopdetails);
    ...
    private void loadProduct() {
        ...
        final StringRequest stringRequest = new StringRequest(Request.Method.POST, PRODUCT_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    Common.progressDialogDismiss(AllShopDetails.this);
                    JSONArray array = new JSONArray(response);
                    Log.d("AAA",response);
                    int total=Integer.parseInt(array.getJSONObject(0).getString("total"));
                    if(total==0)
                    {
                        Toast.makeText(AllShopDetails.this,"No Product Available",Toast.LENGTH_LONG).show();
                        Intent intent=new Intent(AllShopDetails.this, SelectShopTypes.class);
                        ...
                        ShopProductAdapter shopProductAdapter = new ShopProductAdapter(AllShopDetails.this, shopProductModelList);
        ...
        Volley.newRequestQueue(AllShopDetails.this).add(stringRequest);
    }
