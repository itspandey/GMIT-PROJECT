...
import com.aspirepublicschool.gyanmanjari.uniform.Advertise;
import com.aspirepublicschool.gyanmanjari.uniform.AdvertiseAdapter;
...
class CategoryShopAdapter extends RecyclerView.Adapter{
    Context context;
    ...
    public CategoryShopAdapter(Context context, List<CategoryShop> shopModelList) {
        ...
        switch (holder.getItemViewType()) {
            case 0:
                if (getItemViewType(position) == CONTENT) {
                    ...
                    final CategoryShop allShop = shopModelList.get(getRealPosition(position));
                    ...
                    String IMG_URL = com.aspirepublicschool.gyanmanjari.Common.GetBaseImageURL()+"shop/" + allShop.getS_img();
                    ...
                    shopViewHolder.relshop.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            intent.putExtra("cat",CategoryWiseShop.cat);
                            context.startActivity(intent);
                        }
                    });
                    if(allShop.getAval()==0) {
