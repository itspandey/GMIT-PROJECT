...
public class Maths extends AppCompatActivity {
    ...
    private void SendRequest() {
        ...
        StringRequest request=new StringRequest(StringRequest.Method.POST,Webserviceurl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    Common.progressDialogDismiss(Maths.this);
                    ...
                    if(total==0)
                    {
                        Toast.makeText(Maths.this,"No Question",Toast.LENGTH_LONG).show();
                    }
                    else
                    {
                        ...
                        {                            /*  {
                            ...
                            if(object.getString("subject").equals("Maths")) {
                        ...
                        for (int k = 0; k <testQuestionArrayList.size(); k++) {
                            ...
                            Maths.tabLayout.getTabAt(k).setCustomView(tv).setText("" + (k+1));
                        }
                        adapter = new MathsAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Maths.this, ""+error, Toast.LENGTH_LONG).show();
        ...
        Volley.newRequestQueue(Maths.this).add(request);
    }
}
