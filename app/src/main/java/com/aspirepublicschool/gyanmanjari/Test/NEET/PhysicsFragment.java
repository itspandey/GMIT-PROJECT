...
public class PhysicsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if (Neet.dataflags == true) {

            String question = "<html><head> <meta charset=\"utf-8\">\n" +
                    "<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n" +"<script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.4/latest.js?config=TeX-MML-AM_CHTML' async></script>"+
                    "<style>\n" +
                    "pre { white-space:normal !important;}" + "</style></head><body>" + Neet.testQuestionArrayList.get(val).getQuestion() + "</body></html>";
            ...
            String opa = "<html><head> <meta charset=\"utf-8\">\n" +
                    "<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n" +"<script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.4/latest.js?config=TeX-MML-AM_CHTML' async></script>"+
                    "<style>\n" +
                    "pre { white-space:normal !important;}" + "</style></head><body>" + Neet.testQuestionArrayList.get(val).getA() + "</body></html>";
            String opb = "<html><head> <meta charset=\"utf-8\">\n" +
                    "<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n" +"<script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.4/latest.js?config=TeX-MML-AM_CHTML' async></script>"+
                    "<style>\n" +
                    "pre { white-space:normal !important;}" + "</style></head><body>" + Neet.testQuestionArrayList.get(val).getB() + "</body></html>";
            String opc = "<html><head> <meta charset=\"utf-8\">\n" +
                    "<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n" +"<script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.4/latest.js?config=TeX-MML-AM_CHTML' async></script>"+
                    "<style>\n" +
                    "pre { white-space:normal !important;}" + "</style></head><body>" + Neet.testQuestionArrayList.get(val).getC() + "</body></html>";
            String opd = "<html><head> <meta charset=\"utf-8\">\n" +
                    "<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n" +"<script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.4/latest.js?config=TeX-MML-AM_CHTML' async></script>"+
                    "<style>\n" +
                    "pre { white-space:normal !important;}" + "</style></head><body>" + Neet.testQuestionArrayList.get(val).getD() + "</body></html>";
           ...
           // settingsa.setLayoutAlgorithm(WebSettings.LayoutAlgorithm.SINGLE_COLUMN);
            ...
            if(Neet.testQuestionArrayList.get(val).getSelected().equals("A"))
            {
                if (Neet.testQuestionArrayList.get(val).isMark()) {
                    Neet.testQuestionArrayList.get(val).setMark(true);
                    Neet.tabLayout.getTabAt(val).setText("");
                    ...
                    Neet.tabLayout.getTabAt(val).setCustomView(tv).setText("" + (val + 1));
                    a.setChecked(true);
                    Neet.testQuestionArrayList.get(val).setSelected("A");
                } else {
                        a.setChecked(true);
                        Neet.testQuestionArrayList.get(val).setSelected("A");
                        Neet.tabLayout.getTabAt(val).setText("");
            ...
            else if( Neet.testQuestionArrayList.get(val).getSelected().equals("B"))
            {
                if (Neet.testQuestionArrayList.get(val).isMark()) {
                    Neet.testQuestionArrayList.get(val).setMark(true);
                    Neet.tabLayout.getTabAt(val).setText("");
                    ...
                    Neet.testQuestionArrayList.get(val).setSelected("B");
                } else {
                    firstanswer.check(R.id.b);
                    Neet.testQuestionArrayList.get(val).setSelected("B");
                    Neet.tabLayout.getTabAt(val).setText("");
            ...
            else if(Neet.testQuestionArrayList.get(val).getSelected().equals("C"))
            {
                if (Neet.testQuestionArrayList.get(val).isMark()) {
                    Neet.testQuestionArrayList.get(val).setMark(true);
                    Neet.tabLayout.getTabAt(val).setText("");
                    ...
                    Neet.testQuestionArrayList.get(val).setSelected("C");
                } else {
                    firstanswer.check(R.id.c);
                    Neet.testQuestionArrayList.get(val).setSelected("C");
                    Neet.tabLayout.getTabAt(val).setText("");
            ...
            else if(Neet.testQuestionArrayList.get(val).getSelected().equals("D"))
            {
                if (Neet.testQuestionArrayList.get(val).isMark()) {
                    Neet.testQuestionArrayList.get(val).setMark(true);
                    ...
                    tv.setTextColor(Color.parseColor("#E02525"));
                    Neet.tabLayout.getTabAt(val).setCustomView(tv).setText("" + (val + 1));
                    Neet.testQuestionArrayList.get(val).setSelected("D");
                } else {
                    firstanswer.check(R.id.d);
                    Neet.testQuestionArrayList.get(val).setSelected("D");
                    Neet.tabLayout.getTabAt(val).setText("");
            ...
            else if(Neet.testQuestionArrayList.get(val).getSelected().equals("Not Set"))
            {
                if (Neet.testQuestionArrayList.get(val).isMark()) {
                    Neet.testQuestionArrayList.get(val).setMark(true);
                    ...
                    tv.setTextColor(Color.parseColor("#E02525"));
                    Neet.tabLayout.getTabAt(val).setCustomView(tv).setText("" + (val + 1));
                    Neet.testQuestionArrayList.get(val).setSelected("Not Set");
                } else {
                    firstanswer.check(R.id.e);
                    Neet.testQuestionArrayList.get(val).setSelected("Not Set");
                    Neet.tabLayout.getTabAt(val).setText("");
            ...
            /*Cursor rs = mydb.getQuestions(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id());
            if (rs.moveToFirst()) {
                // record exists
                ArrayList<TestAnswer> array_list = mydb.getAllTestData(Neet.testQuestionArrayList.get(val).getTst_id());
            ...
            firstanswer.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    ...
                    switch (selectedid) {
                        case R.id.a:
                            if (Neet.testQuestionArrayList.get(val).getSelected().equals("A")) {
                                if (Neet.testQuestionArrayList.get(val).isMark() == true) {
                                    Neet.tabLayout.getTabAt(val).setText("");
                                    TextView tv = (TextView) LayoutInflater.from(getContext()).inflate(R.layout.custom_view, null);
                                    tv.setTextColor(Color.parseColor("#E02525"));
                                    Neet.tabLayout.getTabAt(val).setCustomView(tv).setText("" + (val + 1));
                                ...
                                if (mydb.updateTest(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), "A")) {
                            ...
                            Neet.testQuestionArrayList.get(val).setSelected("A");
                            // ArrayList<TestAnswer> answers = mydb.getTestData(Neet.testQuestionArrayList.get(val).getTst_id(),Neet.testQuestionArrayList.get(val).getQ_id());
                            if (Neet.testQuestionArrayList.get(val).isMark() == true)
                            {
                                saveAnswers(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), "A", true);
                            }
                            else
                            {
                                saveAnswers(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), "A", false);
                            }

                            break;
                        case R.id.b:
                            if (Neet.testQuestionArrayList.get(val).getSelected().equals("B")) {
                                ...
                                if (mydb.updateTest(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), "B")) {
                            ...
                            if (Neet.testQuestionArrayList.get(val).isMark() == true)
                            {
                                saveAnswers(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), "B", true);
                            }
                            else
                            {
                                saveAnswers(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), "B", false);
                            }

                            break;
                        case R.id.c:
                            if (Neet.testQuestionArrayList.get(val).getSelected().equals("C")) {
                                if (Neet.testQuestionArrayList.get(val).isMark() == true) {
                                    Neet.tabLayout.getTabAt(val).setText("");
                                    TextView tv = (TextView) LayoutInflater.from(getContext()).inflate(R.layout.custom_view, null);
                                    tv.setTextColor(Color.parseColor("#E02525"));
                                ...
                                if (mydb.updateTest(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), "C")) {
                            ...
                            if (Neet.testQuestionArrayList.get(val).isMark() == true)
                            {
                                saveAnswers(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), "C", true);
                            }
                            else
                            {
                                saveAnswers(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), "C", false);
                            }

                            break;
                        case R.id.d:
                            if (Neet.testQuestionArrayList.get(val).getSelected().equals("D")) {
                                if (Neet.testQuestionArrayList.get(val).isMark() == true) {
                                    Neet.tabLayout.getTabAt(val).setText("");
                                    TextView tv = (TextView) LayoutInflater.from(getContext()).inflate(R.layout.custom_view, null);
                                    tv.setTextColor(Color.parseColor("#E02525"));
                                ...
                                if (mydb.updateTest(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), "D")) {
                            ...
                            if (Neet.testQuestionArrayList.get(val).isMark() == true)
                            {
                                saveAnswers(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), "D", true);
                            }
                            else
                            {
                                saveAnswers(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), "D", false);
                            }
                        ...
                        case R.id.e:
                            ...
                            if (rs.moveToFirst()) {
                                ...
                                if (mydb.updateTest(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), "Not Set")) {
                            ...
                            if (Neet.testQuestionArrayList.get(val).isMark() == true)
                            {
                                saveAnswers(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), "Not Set", true);
                            }
                            else
                            {
                                saveAnswers(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), "Not Set", false);
                            }
            ...
            if (Neet.testQuestionArrayList.get(val).getQ_img().equals("Not Set")) {
        ...
        btnmark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Neet.testQuestionArrayList.get(val).isMark() == false) {
                    Neet.testQuestionArrayList.get(val).setMark(true);
                    Neet.tabLayout.getTabAt(val).setText("");
                    TextView tv = (TextView) LayoutInflater.from(getContext()).inflate(R.layout.custom_view, null);
                    tv.setTextColor(Color.parseColor("#E02525"));
                    Neet.tabLayout.getTabAt(val).setCustomView(tv).setText("" + (val + 1));
                    if (mydb.updateMark(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), 1)) {
                    } else {
                    }
                }
                if (Neet.testQuestionArrayList.get(val).isMark() == true)
                {
                    saveAnswers(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), Neet.testQuestionArrayList.get(val).getSelected(), true);
                }
                else
                {
                    saveAnswers(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), Neet.testQuestionArrayList.get(val).getSelected(), false);
                }
            }
        });
        btnsave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Neet.testQuestionArrayList.get(val).isMark() == true) {
                    if (Neet.testQuestionArrayList.get(val).getSelected().equals("Not Set")) {
                        Neet.testQuestionArrayList.get(val).setMark(false);
                        Neet.tabLayout.getTabAt(val).setText("");
                        TextView tv = (TextView) LayoutInflater.from(getContext()).inflate(R.layout.custom_view, null);
                        tv.setTextColor(Color.WHITE);
                        Neet.tabLayout.getTabAt(val).setCustomView(tv).setText("" + (val + 1));
                        if (mydb.updateMark(Neet.testQuestionArrayList.get(val).getTst_id(), Neet.testQuestionArrayList.get(val).getQ_id(), 0)) {
                        } else {
                        }
                    } else {
                        Neet.tabLayout.getTabAt(val).setText("");
