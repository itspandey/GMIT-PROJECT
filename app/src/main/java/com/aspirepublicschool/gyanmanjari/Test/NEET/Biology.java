...
public class Biology extends AppCompatActivity {
    ...
    private void SendRequest() {
        ...
        StringRequest request=new StringRequest(StringRequest.Method.POST,Webserviceurl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    Common.progressDialogDismiss(Biology.this);
                    ...
                    if(total==0)
                    {
                        Toast.makeText(Biology.this,"No Question",Toast.LENGTH_LONG).show();
                    }
                    else
                    {
                        ...
                        for (int k = 0; k <testQuestionArrayList.size(); k++) {
                            ...
                            Biology.tabLayout.getTabAt(k).setCustomView(tv).setText("" + (k+1));
                        }
                        adapter = new BiologyAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Biology.this, ""+error, Toast.LENGTH_LONG).show();
        ...
        Volley.newRequestQueue(Biology.this).add(request);
    }
}
