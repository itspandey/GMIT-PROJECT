...
public class WRTTestModel {
    ...
    String sc_id,t_id,cid,subject,stime,etime,q_doc,sol_doc,tst_date,total,tst_ans_status,obtain,tst_id,ans_doc,remarks,gr_no;

    public WRTTestModel(String sc_id, String t_id, String cid, String subject, String stime, String etime, String q_doc, String sol_doc, String tst_date, String total, String tst_ans_status, String obtain, String tst_id, String ans_doc, String remarks, String gr_no) {
        this.sc_id = sc_id;
        this.t_id = t_id;
        this.cid = cid;
